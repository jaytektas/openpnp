...
public class JogControlsPanel extends JPanel {
	...
	private void createUi() {
		...
		// We set this Icon explicitly as a WindowBuilder helper. WindowBuilder can't
		// find the
		// homeAction referenced above so the icon doesn't render in the viewer. We set
		// it here
		...
		JLabel lblDistance = new JLabel("<html>" + Translations.getString("JogControlsPanel.Label.Distance") + "<br>[" //$NON-NLS-1$
				+ configuration.getSystemUnits().getShortName() + "/deg]</html>");
		...
		JLabel lblSpeed = new JLabel(
				"<html>" + Translations.getString("JogControlsPanel.Label.Speed") + "<br>[%]</html>"); //$NON-NLS-1$
		...
		boardProtectionCheck = new JCheckBox(Translations.getString("JogControlsPanel.Label.BoardProtection")); //$NON-NLS-1$
		boardProtectionCheck.setSelected(true);
		boardProtectionCheck
				.setToolTipText(Translations.getString("JogControlsPanel.Label.BoardProtection.Description")); //$NON-NLS-1$
	...
	@SuppressWarnings("serial")
	public Action xyParkAction = new AbstractAction(Translations.getString("JogControlsPanel.Action.ParkXY"), //$NON-NLS-1$
			Icons.park) {
		@Override
		public void actionPerformed(ActionEvent arg0) {
			UiUtils.submitUiMachineTask(() -> {
	...
	@SuppressWarnings("serial")
	public Action zParkAction = new AbstractAction(Translations.getString("JogControlsPanel.Action.ParkZ"), //$NON-NLS-1$
			Icons.park) {
		@Override
		public void actionPerformed(ActionEvent arg0) {
			UiUtils.submitUiMachineTask(() -> {
				...
				// Note, we don't just moveToSafeZ(), because this will just sit still, if we're
				// already in the Safe Z Zone.
				// instead we explicitly move to the effective Safe Z coordinate i.e. the lower
				// bound of the Safe Z Zone, applicable
				// for this hm (and in case of Dynamic Safe Z with the part height accounted
				// for).
	...
	@SuppressWarnings("serial")
	public Action cParkAction = new AbstractAction(Translations.getString("JogControlsPanel.Action.ParkC"), //$NON-NLS-1$
			Icons.park) {
		@Override
		public void actionPerformed(ActionEvent arg0) {
			UiUtils.submitUiMachineTask(() -> {
				...
				if (hm instanceof AbstractNozzle) {
					...
					if (nozzle.getRotationMode() == RotationMode.LimitedArticulation) {
						...
						if (parkAngle < limits[0] || parkAngle > limits[1]) {
							// Rounded mid-point outside limits? Can this ever happen? If yes, fall back to
							// exact mid-point.
	...
	@SuppressWarnings("serial")
	public Action raiseIncrementAction = new AbstractAction(
			Translations.getString("JogControlsPanel.Action.RaiseJogIncrement")) { //$NON-NLS-1$
		@Override
		public void actionPerformed(ActionEvent arg0) {
	...
	@SuppressWarnings("serial")
	public Action lowerIncrementAction = new AbstractAction(
			Translations.getString("JogControlsPanel.Action.LowerJogIncrement")) { //$NON-NLS-1$
		@Override
		public void actionPerformed(ActionEvent arg0) {
	...
	@SuppressWarnings("serial")
	public Action setIncrement1Action = new AbstractAction(
			Translations.getString("JogControlsPanel.Action.FirstJogIncrement")) { //$NON-NLS-1$
		@Override
		public void actionPerformed(ActionEvent arg0) {
	...
	@SuppressWarnings("serial")
	public Action setIncrement2Action = new AbstractAction(
			Translations.getString("JogControlsPanel.Action.SecondJogIncrement")) { //$NON-NLS-1$
		@Override
		public void actionPerformed(ActionEvent arg0) {
	...
	@SuppressWarnings("serial")
	public Action setIncrement3Action = new AbstractAction(
			Translations.getString("JogControlsPanel.Action.ThirdJogIncrement")) { //$NON-NLS-1$
		@Override
		public void actionPerformed(ActionEvent arg0) {
	...
	@SuppressWarnings("serial")
	public Action setIncrement4Action = new AbstractAction(
			Translations.getString("JogControlsPanel.Action.FourthJogIncrement")) { //$NON-NLS-1$
		@Override
		public void actionPerformed(ActionEvent arg0) {
	...
	@SuppressWarnings("serial")
	public Action setIncrement5Action = new AbstractAction(
			Translations.getString("JogControlsPanel.Action.FifthJogIncrement")) { //$NON-NLS-1$
		@Override
		public void actionPerformed(ActionEvent arg0) {
		...
		public void configurationComplete(Configuration configuration) throws Exception {
			...
			PropertyChangeListener recyclePropertyListener = (e) -> {
				...
				if (selectedNozzle != null) {
					...
					if (part != null) {
						for (Feeder feeder : Configuration.get().getMachine().getFeeders()) {
							if (feeder.isEnabled() && feeder.getPart() == part && feeder.canTakeBackPart()) {
								canTakeBack = true;
							}
						}
					}
			...
			// add to the currently selected tool, so we get a notification if that changed,
			// maybe other part on the nozzle
